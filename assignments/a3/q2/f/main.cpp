...
int main ( ) {
    ...
    unordered_map<string, float> subtotals;
    char type;
    ...
    for_each(orders.begin(), orders.end(), [&menu, &subtotals](const pair<string, int> &order) {
    ...
    float total = accumulate(subtotals.begin(), subtotals.end(), 0.0, [](float total, const pair<string, float> &subtotal) {
