...
int main ( ) {
    ...
    float priceInc;
    cout << endl << "Enter the size of the price increment: " << endl;
    cin >> priceInc;

    for_each(menu->begin(), menu->end(), [&priceInc](MenuComponent *item) {
        item->priceIs(item->price() + priceInc);
    });

    copy(menu->begin(), menu->end(), ostream_iterator<const MenuComponent*>(cout, "\n"));

    /* transform (menu->begin(), menu->end(), ostream_iterator<const MenuComponent*>(cout, "\n"),
            [&priceInc](MenuComponent *item) {
        item->priceIs(item->price() + priceInc);
    }); */
